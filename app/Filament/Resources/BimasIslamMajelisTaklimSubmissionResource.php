...
use App\Filament\Resources\BimasIslamMajelisTaklimSubmissionResource\Pages;
...
class BimasIslamMajelisTaklimSubmissionResource extends Resource
{
    protected static ?string $model = Submission::class;

    protected static ?string $navigationIcon = 'heroicon-o-users';
    protected static ?string $navigationLabel = 'Majelis Taklim';
    protected static ?string $pluralLabel = 'Majelis Taklim';
    protected static ?string $slug = 'bimas-majelis-taklim-submissions';
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->whereHas('service', function ($query) {
            $query->where('slug', 'bimas-majelis-taklim');
        });
    }
                ...
                Forms\Components\Section::make('Berkas Persyaratan')
                    ->schema([
                        ...
                        FileUpload::make('content.files.surat_komitmen')
                            ...
                            ->downloadable()
                            ->openable(),
                        FileUpload::make('content.files.ktp_pengurus_jamaah')
                            ->label('KTP Pengurus & Jamaah')
                            ->disk('public')
                            ->disabled()
                            ->downloadable()
                            ->openable(),
                        FileUpload::make('content.files.dokumentasi_kegiatan')
    ...
    {
        return [
            'index' => Pages\ListBimasIslamMajelisTaklimSubmissions::route('/'),
        ];
    }
