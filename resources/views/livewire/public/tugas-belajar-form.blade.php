    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="email" wire:model="email" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 transition shadow-sm" placeholder="Email aktif">
        ...
        @else
            <div class="p-8 text-center bg-gray-50">
                ...
                <div class="mt-6">
                     <a href="{{ route('layanan.kepegawaian') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium">
