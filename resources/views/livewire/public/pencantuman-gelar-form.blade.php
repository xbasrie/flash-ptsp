            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="email" wire:model="email" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 transition shadow-sm" placeholder="Email aktif">
