<div class="max-w-5xl mx-auto py-10 px-4">
    ...
    <div class="text-center mb-10 relative">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">Permohonan ID Masjid & Musholla</h1>
        <p class="mt-4 text-lg text-gray-500">Ajukan nomor ID untuk Masjid atau Musholla Anda secara online.</p>
    </div>
        ...
        <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Isi data pemohon dan detail masjid/musholla.</p>
                </div>
                <!-- Step 2 -->
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
            ...
            <form wire:submit="save" class="space-y-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Surat Permohonan -->
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Surat Permohonan <span class="text-gray-500 text-xs">(Kepada Kankemenag Surabaya mengetahui Kepala KUA)</span></label>
                        ...
                        <!-- Proposal -->
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Proposal <span class="text-gray-500 text-xs">(Sejarah, Deskripsi, Profil Masjid/Musholla)</span></label>
                        ...
                        <!-- SK Takmir -->
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">SK Kepengurusan / Takmir</label>
                            <input type="file" wire:model="sk_takmir" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('sk_takmir') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <!-- Status Tanah -->
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Bukti Status Tanah <span class="text-gray-500 text-xs">(Sertifikat/AIW/Ikrar Wakaf/dll)</span></label>
                        ...
                        <!-- Foto Masjid -->
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Foto Masjid/Musholla <span class="text-gray-500 text-xs">(Depan, Dalam, Wudhu - Gabung PDF/ZIP)</span></label>
                            <input type="file" wire:model="foto_masjid" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('foto_masjid') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
