<div class="max-w-5xl mx-auto py-10 px-4">
    ...
    <div class="text-center mb-10 relative">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">Pendaftaran Majelis Taklim</h1>
        <p class="mt-4 text-lg text-gray-500">Daftarkan Majelis Taklim Anda untuk mendapatkan Surat Keterangan Terdaftar (SKT).</p>
        <a href="https://bit.ly/SKTMASJID_MUSHALLA_MAJELISTAKLIM" target="_blank" class="text-sm font-medium text-green-600 hover:text-green-500 underline mt-2 block">
            Download Contoh Format Surat Disini
        </a>
    </div>
        ...
        <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Isi identitas pengurus dan data profil majelis taklim.</p>
                </div>
                <!-- Step 2 -->
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
        ...
        <div class="p-8">
            ...
            <form wire:submit="save" class="space-y-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Surat Permohonan <span class="text-gray-500 text-xs">(Ke Kankemenag via KUA)</span></label>
                        ...
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Proposal / Uraian Singkat</label>
                            <input type="file" wire:model="proposal" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('proposal') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Susunan Pengurus <span class="text-gray-500 text-xs">(Ketua, Sekretaris, Bendahara)</span></label>
                            <input type="file" wire:model="susunan_pengurus" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('susunan_pengurus') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Surat Keterangan Domisili <span class="text-gray-500 text-xs">(Dari Kelurahan)</span></label>
                            <input type="file" wire:model="surat_domisili" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('surat_domisili') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Surat Pernyataan Tidak Konflik</label>
                        ...
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Surat Komitmen Kebangsaan</label>
                        ...
                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">FC KTP Pengurus & Jamaah</label>
                            <input type="file" wire:model="ktp_pengurus_jamaah" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('ktp_pengurus_jamaah') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>

                        <div class="group">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Dokumentasi Kegiatan</label>
                            <input type="file" wire:model="dokumentasi_kegiatan" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100">
                            @error('dokumentasi_kegiatan') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            ...
            @else
                <div class="p-8 text-center bg-gray-50">
                    ...
                    <div class="mt-6">
                         <a href="{{ route('layanan.bimas-islam') }}" class="inline-flex items-center text-green-600 hover:text-green-700 font-medium">
                            &larr; Kembali ke Layanan Bimas Islam
                         </a>
                    </div>
                </div>
            @endif
