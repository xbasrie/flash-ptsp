<div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-10 text-center">
        <a href="{{ route('layanan.kepegawaian') }}" class="inline-flex items-center text-teal-600 hover:text-teal-700 font-medium mb-4 transition">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
            </svg>
            Kembali ke Layanan Kepegawaian
        </a>
        <h1 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">Usul Ralat Data SIASN</h1>
        <p class="mt-2 text-lg text-gray-500">Layanan usul perbaikan data profil pegawai pada sistem SIASN BKN.</p>
    </div>
        ...
        <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Lengkapi data diri dan detail usulan perbaikan.</p>
                </div>
                <!-- Step 2 -->
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Unggah dokumen pendukung sesuai persyaratan.</p>
                </div>
                 <!-- Step 3 -->
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500">Simpan Kode Tracking untuk cek status berkala.</p>
                </div>
                 <!-- Step 4 -->
                 <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition text-center border border-gray-100">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" wire:model="nama" id="nama" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm" placeholder="Nama lengkap beserta gelar">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" wire:model="nip" id="nip" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm" placeholder="19xxxxxxxxxxxxxx">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" wire:model="unit_kerja" id="unit_kerja" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm" placeholder="Contoh: Kemenag Kota Surabaya">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" wire:model="jabatan" id="jabatan" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm" placeholder="Contoh: Analis Kepegawaian">
                    ...
                    <div class="col-span-1">
                        ...
                        <select wire:model="pangkat_golongan" id="pangkat_golongan" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm">
                        ...
                        @error('pangkat_golongan') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                    </div>

                    <!-- No HP -->
                    <div class="col-span-1">
                        <label for="no_hp" class="block text-sm font-medium text-gray-700 mb-1">No. HP (WhatsApp)</label>
                        <input type="text" wire:model="no_hp" id="no_hp" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm" placeholder="08xxxxxxxxxx">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <input type="email" wire:model="email" id="email" class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500 transition shadow-sm" placeholder="email@contoh.com">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="file" wire:model="sptjm" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100 transition">
                        <p class="text-xs text-gray-400 mt-1">PDF/JPG, Maks 5MB.</p>
                    ...
                    <!-- Surat Persetujuan -->
                     <div class="col-span-1">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Surat Persetujuan</label>
                        <input type="file" wire:model="surat_persetujuan" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100 transition">
                         <p class="text-xs text-gray-400 mt-1">PDF/JPG, Maks 5MB.</p>
                         @error('surat_persetujuan') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                    </div>

                    <!-- Data Pendukung Layout -->
                    <div class="col-span-1">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Data Pendukung Lainnya</label>
                        <input type="file" wire:model="data_pendukung" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100 transition">
                        <p class="text-xs text-gray-400 mt-1">PDF/JPG/ZIP, Maks 10MB.</p>
                        @error('data_pendukung') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                    </div>
                </div>
            </section>
